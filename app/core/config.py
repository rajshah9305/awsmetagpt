...
class Settings(BaseSettings):
    """Main settings class with flat structure for better env var support"""
    ...
    def get_env_vars(self) -> Dict[str, str]:
        ...
        env_vars = {
            ...
            'METAGPT_ENABLE_LONGTERM_MEMORY': 'true'
        }
...
# Validate settings immediately after creation
