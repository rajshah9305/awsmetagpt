...
async def generate_app(
    ...
    try:
        ...
        ws_protocol = "wss" if not settings.core.DEBUG else "ws"
...
async def get_available_bedrock_models(services: dict = Depends(get_services)):
    ...
    try:
        ...
        return {
            "models": models,
            "current_model": settings.bedrock.BEDROCK_MODEL
        }
...
def _get_role_description(role) -> str:
    ...
    descriptions = {
        "product_manager": "Analyzes requirements and creates product specifications",
        "architect": "Designs system architecture and technical specifications", 
        "project_manager": "Creates project plans and manages task coordination",
        "engineer": "Implements application code and core functionality",
        "qa_engineer": "Creates and executes tests for quality assurance",
        "devops": "Handles deployment and infrastructure configuration"
    }
