    ...
    <div className="glass-card p-7">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="btn-primary text-sm py-2.5 disabled:opacity-50 disabled:cursor-not-allowed gap-1.5"
        >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="btn-secondary text-sm py-2.5 disabled:opacity-50 disabled:cursor-not-allowed gap-1.5"
        >
          <Play className="w-4 h-4 flex-shrink-0" />
          Run App
        </motion.button>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="btn text-sm py-2.5 bg-error-500 text-white hover:bg-error-600 disabled:opacity-50 disabled:cursor-not-allowed gap-1.5"
        >
        ...
        <div className="mt-7 grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <div key={label} className="bg-neutral-50 rounded-2xl p-4 border border-neutral-100">
              <p className="caption text-neutral-400 mb-1">{label}</p>
