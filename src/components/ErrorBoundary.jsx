    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4">
          <div className="glass-card p-8 max-w-md w-full text-center border-t-4 border-error-500">
            ...
            {process.env.NODE_ENV === 'development' && (
              <div className="mt-8 text-left p-4 bg-neutral-100 rounded-lg overflow-auto max-h-40">
