        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
              ...
              >
                <div className="glass-card p-5 sm:p-8">
                  <h2 className="text-lg sm:text-xl font-display font-semibold text-neutral-900 mb-2 sm:mb-3 flex items-center gap-3">
                    ...
                    {showAdvanced && (
                      ...
                      >
                        <div className="mt-5 sm:mt-6 space-y-5 sm:space-y-6">
                          {/* AI Model Selection */}
                          <div>
                            <label className="label block mb-2">Preferred AI Model</label>
                            <select
                            ...
                            <p className="caption mt-2">
                              Nova Pro is recommended for most applications.
                            </p>
                          </div>
